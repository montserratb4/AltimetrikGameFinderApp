const apiURL = `https://api.rawg.io/api/games?key=8c85ae1535a8482ca51c6559a93c705e&dates=2019-09-01,2019-09-30&platforms=18,1,7`;

function createCard(gamesJson, i) {
  const card = `<div class="card">
            ...
            <div class="cardInfo">
              <div class="gameTitle">
                <span class="gameName">${gamesJson.results[i].name}</span>
                <span class="gameNumber">#${i + 1}</span>
              </div>
              <div class="gameInfo">
                <div class="infoContainer">
                  ...
                  <div class="infoAnswers">
                    ...
                    <div class="genreWrapper">
                      <span class="genres">${getGenres(
                        gamesJson.results[i].genres
                      )}</span>
                    </div>
                  </div>
                </div>
                <div class="consoleIcons">  ${getIcons(
                  gamesJson.results[i].parent_platforms
                )}
                  <div class="etcDots"></div>
                </div>
              </div>
            </div>
          </div>`;
...
async function getGames() {
  ...
  const cardWrapper = document.querySelector(".cardsContainer");
  console.log(gamesJson.results);
  for (let i = 0; i < gamesJson.results.length; i++) {
    cardWrapper.innerHTML += createCard(gamesJson, i);
  }
}
getGames();
